    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-4xl tracking-wider text-foreground mb-1">新規登録</h1>
          <p className="text-muted-foreground text-sm">Oishi Niku アカウントを作成</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input name="name" type="text" required placeholder="山田 太郎" autoComplete="name" className={`${inputCls} pl-9`} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input name="password" type={showPw ? 'text' : 'password'} required placeholder="8文字以上" autoComplete="new-password" className={`${inputCls} pl-9 pr-11`} />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <input name="confirm" type={showConfirm ? 'text' : 'password'} required placeholder="もう一度入力" autoComplete="new-password" className={`${inputCls} pl-9 pr-11`} />
            ...
            <p className="text-center text-sm text-muted-foreground pt-2">
              すでにアカウントをお持ちの方は{' '}
              <Link href="/auth/login" className="text-primary font-semibold hover:underline">ログイン</Link>
            </p>
          </form>
        </div>
      </div>
